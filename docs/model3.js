...
//   new THREE.Vector3(-100, 0, 100),
// ]);
var v1 = new THREE.Vector3(9000, -6000, -10000)
var v2 = new THREE.Vector3(-3650, 4000, 4000)
...
for (var i = 0; i < newPoints2.length; i++) {
  ...
  var color2 = new THREE.Color(0x33ffff); //黄色
...
model3.rotation.x = THREE.MathUtils.degToRad(90);
// 飞线动画
